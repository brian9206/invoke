...
module.exports = {
  async up({ context: { queryInterface, Sequelize } }) {
    ...
    await queryInterface.addConstraint('function_versions', {
      fields: ['function_id', 'version'],
      type: 'unique',
      name: 'uq_function_version'
    })
    ...
    await queryInterface.addConstraint('function_environment_variables', {
      fields: ['function_id', 'variable_name'],
      type: 'unique',
      name: 'uq_env_var'
    })
    ...
    await queryInterface.addConstraint('api_gateway_configs', {
      fields: ['project_id'],
      type: 'unique',
      name: 'uq_gateway_project'
    })
    await queryInterface.addConstraint('api_gateway_configs', {
      fields: ['custom_domain'],
      type: 'unique',
      name: 'uq_gateway_custom_domain'
    })
    ...
    await queryInterface.addConstraint('api_gateway_routes', {
      fields: ['gateway_config_id', 'route_path'],
      type: 'unique',
      name: 'uq_gateway_route_path'
    })
    await queryInterface.addConstraint('api_gateway_routes', {
      fields: ['auth_logic'],
      type: 'check',
    ...
    await queryInterface.addConstraint('api_gateway_route_settings', {
      fields: ['route_id'],
      type: 'unique',
      name: 'uq_gateway_route_settings_route_id'
    })
    ...
    await queryInterface.addConstraint('api_gateway_auth_methods', {
      fields: ['gateway_config_id', 'name'],
      type: 'unique',
      name: 'uq_gateway_auth_method_name'
    })
    ...
    await queryInterface.addIndex('api_gateway_configs', ['project_id'], { name: 'idx_gateway_configs_project_id' })
    ...
    await queryInterface.addIndex('api_gateway_routes', ['function_id'], { name: 'idx_gateway_routes_function_id' })
    ...
    await queryInterface.bulkInsert('global_settings', [
      {
        setting_key: 'log_retention_type',
        setting_value: 'time',
        description: 'Default log retention type: time, count, or none'
      },
      {
        setting_key: 'log_retention_value',
        setting_value: '7',
        description: 'Default log retention value (7 days or 1000 count)'
      },
      {
        setting_key: 'log_retention_enabled',
        setting_value: 'true',
        description: 'Whether log retention cleanup is enabled globally'
      },
      {
      ...
      },
      {
        ...
        description: 'Maximum storage size for project KV store in bytes (default 1GB)'
      },
      {
    ...
    await queryInterface.bulkInsert('projects', [
      {
        ...
        description: 'Your first default project',
        created_by: null,
        created_at: new Date(),
        updated_at: new Date()
      }
    ...
    await queryInterface.bulkInsert('global_network_policies', [
      {
        ...
        description: 'Block private network (RFC1918)',
        priority: 1,
        created_at: new Date()
      },
      {
    ...
    await queryInterface.bulkInsert('project_network_policies', [
      {
        ...
        target_type: 'cidr',
        target_value: '0.0.0.0/0',
        description: 'Allow all public IPv4',
        priority: 1,
        created_at: new Date()
      },
      {
        ...
        target_type: 'cidr',
        target_value: '::/0',
        description: 'Allow all public IPv6',
        priority: 2,
        created_at: new Date()
      }
    ])
