...
class MigrationManager {
  ...
  async getMigrationStatus() {
    const [pending, executed] = await Promise.all([this.umzug.pending(), this.umzug.executed()])
  ...
  async _bootstrapFromLegacy() {
    try {
      ...
      await this.sequelize.query('INSERT INTO "SequelizeMeta" (name) VALUES ($1) ON CONFLICT DO NOTHING', {
