...
module.exports = async function (req, res) {
  ...
  try {
    ...
    // Test chaining
    const chainedHash = crypto.createHash('sha256').update('Part 1 ').update('Part 2').digest('hex')
    ...
    // Test HMAC chaining
    const chainedHmac = crypto.createHmac('sha256', 'key').update('Part A ').update('Part B').digest('base64')
