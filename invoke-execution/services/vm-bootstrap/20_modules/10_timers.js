...
(function() {
    ...
    const timersModule = {};
    builtinModule['timers'] = timersModule;
    
    timersModule.setTimeout = function(callback, delay, ...args) {
    ...
    timersModule.setInterval = function(callback, delay, ...args) {
        if (typeof callback !== 'function') {
            throw new TypeError('Callback must be a function');
        }
    ...
    timersModule.setImmediate = function(callback, ...args) {
        if (typeof callback !== 'function') {
            throw new TypeError('Callback must be a function');
        }
    ...
    timersModule.clearTimeout = function(timeout) {
    ...
    timersModule.clearInterval = timersModule.clearTimeout;
    
    timersModule.clearImmediate = function(immediate) {
    ...
    // Export classes
    timersModule.Timeout = Timeout;
    timersModule.Immediate = Immediate;
    ...
    builtinModule['timers/promises'] = timersPromises;
    ...
    // Expose global
    globalThis.setTimeout = timersModule.setTimeout;
    globalThis.setInterval = timersModule.setInterval;
    globalThis.setImmediate = timersModule.setImmediate;
    globalThis.clearTimeout = timersModule.clearTimeout;
    globalThis.clearInterval = timersModule.clearInterval;
    globalThis.clearImmediate = timersModule.clearImmediate;
