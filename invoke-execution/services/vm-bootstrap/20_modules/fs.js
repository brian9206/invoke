(function() {
    ...
    self.appendFileSync = function(...args) {
        try {
    ...
    self.readdirSync = function(...args) {
        try {
    ...
    self.copyFileSync = function(...args) {
        try {
    ...
    self.readSync = function(fd, buffer, offset, length, position) {
        try {
    ...
    self.writeSync = function(fd, buffer, offset, length, position) {
        try {
            // Convert buffer to ArrayBuffer for transfer to host
            const bufferArrayBuffer = buffer.buffer.slice(buffer.byteOffset, buffer.byteOffset + buffer.byteLength);
    ...
    self.truncateSync = function(...args) {
        try {
    ...
    self.ftruncateSync = function(...args) {
        try {
    ...
    self.read = function(fd, buffer, offset, length, position, callback) {
    ...
    self.write = function(fd, buffer, offsetOrCallback, lengthOrCallback, positionOrCallback, callback) {
        const originalBuffer = buffer;
        // Convert buffer to ArrayBuffer for transfer to host
        const bufferArrayBuffer = buffer.buffer.slice(buffer.byteOffset, buffer.byteOffset + buffer.byteLength);
    ...
    self.promises.writeFile = async function(...args) {
        try {
    ...
    self.promises.appendFile = async function(...args) {
        try {
    ...
    self.promises.stat = async function(...args) {
        try {
    ...
    self.promises.readdir = async function(...args) {
        try {
    ...
    self.promises.access = async function(...args) {
        try {
    ...
    self.promises.mkdir = async function(...args) {
        try {
    ...
    self.promises.unlink = async function(...args) {
        try {
    ...
    self.promises.rmdir = async function(...args) {
        try {
    ...
    self.promises.rename = async function(...args) {
        try {
    ...
    self.promises.copyFile = async function(...args) {
        try {
    ...
    self.promises.chmod = async function(...args) {
        try {
    ...
    self.promises.chown = async function(...args) {
        try {
