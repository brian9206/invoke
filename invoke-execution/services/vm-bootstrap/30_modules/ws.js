(function() {
    // Register module 'ws' (WebSocket)
    const self = {};
    builtinModule['ws'] = self;
    ...
    self.default = WebSocket;
    self.WebSocketServer = WebSocketServer;
    self.Server = WebSocketServer;

    // Constants
    self.CONNECTING = WebSocket.CONNECTING;
    self.OPEN = WebSocket.OPEN;
    self.CLOSING = WebSocket.CLOSING;
    self.CLOSED = WebSocket.CLOSED;
})();