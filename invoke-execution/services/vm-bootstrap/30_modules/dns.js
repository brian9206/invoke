(function() {
    // Register module 'dns'
    const self = {};
    builtinModule['dns'] = self;

    // DNS error codes
    self.NODATA = 'ENODATA';
    self.FORMERR = 'EFORMERR';
    self.SERVFAIL = 'ESERVFAIL';
    self.NOTFOUND = 'ENOTFOUND';
    self.NOTIMP = 'ENOTIMP';
    self.REFUSED = 'EREFUSED';
    self.BADQUERY = 'EBADQUERY';
    self.BADNAME = 'EBADNAME';
    self.BADFAMILY = 'EBADFAMILY';
    self.BADRESP = 'EBADRESP';
    self.CONNREFUSED = 'ECONNREFUSED';
    self.TIMEOUT = 'ETIMEOUT';
    self.EOF = 'EOF';
    self.FILE = 'EFILE';
    self.NOMEM = 'ENOMEM';
    self.DESTRUCTION = 'EDESTRUCTION';
    self.BADSTR = 'EBADSTR';
    self.BADFLAGS = 'EBADFLAGS';
    self.NONAME = 'ENONAME';
    self.BADHINTS = 'EBADHINTS';
    self.NOTINITIALIZED = 'ENOTINITIALIZED';
    self.LOADIPHLPAPI = 'ELOADIPHLPAPI';
    self.ADDRGETNETWORKPARAMS = 'EADDRGETNETWORKPARAMS';
    self.CANCELLED = 'ECANCELLED';
    ...
    self.lookup = function(hostname, options, callback) {
    ...
    self.lookupService = function(address, port, callback) {
    ...
    self.resolve = function(hostname, rrtype, callback) {
    ...
    self.resolve4 = function(hostname, options, callback) {
        let actualOptions = {};
        let actualCallback = callback;
    ...
    self.resolve6 = function(hostname, options, callback) {
        let actualOptions = {};
        let actualCallback = callback;
    ...
    self.resolveAny = function(hostname, callback) {
        if (typeof callback !== 'function') {
            throw new TypeError('callback must be a function');
        }
    ...
    self.resolveCname = function(hostname, callback) {
        if (typeof callback !== 'function') {
            throw new TypeError('callback must be a function');
        }
    ...
    self.resolveMx = function(hostname, callback) {
        if (typeof callback !== 'function') {
            throw new TypeError('callback must be a function');
        }
    ...
    self.resolveNaptr = function(hostname, callback) {
        if (typeof callback !== 'function') {
            throw new TypeError('callback must be a function');
        }
    ...
    self.resolveNs = function(hostname, callback) {
        if (typeof callback !== 'function') {
            throw new TypeError('callback must be a function');
        }
    ...
    self.resolvePtr = function(hostname, callback) {
        if (typeof callback !== 'function') {
            throw new TypeError('callback must be a function');
        }
    ...
    self.resolveSoa = function(hostname, callback) {
        if (typeof callback !== 'function') {
            throw new TypeError('callback must be a function');
        }
    ...
    self.resolveSrv = function(hostname, callback) {
        if (typeof callback !== 'function') {
            throw new TypeError('callback must be a function');
        }
    ...
    self.resolveTxt = function(hostname, callback) {
        if (typeof callback !== 'function') {
            throw new TypeError('callback must be a function');
        }
    ...
    self.reverse = function(ip, callback) {
        if (typeof callback !== 'function') {
            throw new TypeError('callback must be a function');
        }
