(function() {
    // Register module 'http'
    const self = {};
    builtinModule['http'] = self;
        ...
        _parseHeaders(headerData) {
            ...
            if (this.type === 'response') {
                ...
                if (statusMatch) {
                    ...
                    this.statusMessage = statusMatch[3] || self.STATUS_CODES[this.statusCode] || '';
                }
            } else {
    ...
    class ClientRequest extends OutgoingMessage {
        constructor(options, callback) {
            ...
            this.agent = options.agent !== undefined ? options.agent : self.globalAgent;
    ...
    self.get = function(url, options, callback) {
        if (typeof url === 'string') {
            ...
            const req = self.request(requestOptions, callback);
            req.end();
            return req;
        }
    };
