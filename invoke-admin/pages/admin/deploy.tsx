              ...
              {activeProject && !user?.isAdmin && activeProject.role === 'developer' && (
                <Card>
                  <CardContent className='py-8 text-center'>
                    ...
                    <p className='text-muted-foreground'>
                      Your current project role does not allow deploying functions. Contact a project owner to deploy
                      functions.
                    </p>
                  </CardContent>
                </Card>
                  ...
                  <CardContent className='pt-6 space-y-6'>
                        ...
                        <div className='flex items-center gap-4 p-4 bg-card border border-border rounded-lg'>
                          ...
                          <div>
                            ...
                            <p className='text-muted-foreground text-sm mt-1'>
                              This will create a simple function that returns a &quot;Hello World&quot; message. You can
                              edit the code directly in the admin panel after creation.
                            </p>
                          </div>
                        </div>
                      </TabsContent>
                    ...
                    <div className='space-y-4'>
                      <div className='space-y-1.5'>
                        ...
                        <Input
                          ...
                          placeholder={
                            creationMode === 'helloworld' ? 'Enter function name' : 'Leave empty to use filename'
                          }
                        />
                      </div>
                        ...
                        <div className='flex-1'>
                          ...
                          {uploadResult.success && uploadResult.data && (
                            <div className='mt-2 text-sm space-y-1'>
                              <p>
                                <strong>Function ID:</strong> {uploadResult.data.id}
                              </p>
                              <p>
                    ...
                    <div className='p-4 bg-muted/40 border border-border rounded-lg'>
                      ...
                      <ul className='text-sm text-muted-foreground space-y-1'>
                        ...
                        <li>
                          • Must contain an <code className='bg-muted px-1 rounded'>index.js</code> file as entry point
                        </li>
                        <li>
                          • Function should export a single function compatible with Express:{' '}
                          <code className='bg-muted px-1 rounded'>{`(req, res) => {}`}</code>
                        </li>
                        <li>• Maximum file size: 50MB</li>
                        <li>
                          • Access your function via{' '}
                          <code className='bg-muted px-1 rounded'>{functionBaseUrl}/&lt;function-id&gt;</code>
                        </li>
                      </ul>
                    </div>
                  </CardContent>
