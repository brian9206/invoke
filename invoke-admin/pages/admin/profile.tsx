                    ...
                    {editingEmail ? (
                      <form onSubmit={handleEmailChange} className='flex items-center gap-2'>
                        ...
                        <Button type='submit' size='sm' disabled={emailLoading || !emailValue}>
                          {emailLoading ? <Loader className='w-4 h-4 animate-spin' /> : <Check className='w-4 h-4' />}
                        </Button>
                        <Button
                          type='button'
                          variant='ghost'
              ...
              <Card>
                <CardContent className='pt-6 space-y-4'>
                  ...
                  <p className='text-sm text-muted-foreground'>
                    API keys have the same permissions as your user account. Use them to authenticate CLI tools and
                    automated scripts.
                  </p>
          ...
          <div className='space-y-4'>
            ...
            <div className='p-3 bg-yellow-900/20 border border-yellow-700/50 rounded-lg'>
              ...
              <p className='text-xs text-yellow-300/80 mt-0.5'>
                You won't be able to view it again. If you lose it, generate a new one.
              </p>
            </div>
