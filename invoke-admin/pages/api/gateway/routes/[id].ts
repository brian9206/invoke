...
async function handler(req: AuthenticatedRequest, res: any) {
  ...
  if (req.method === 'PUT') {
    ...
    const { routePath, functionId, allowedMethods, isActive, corsSettings, authMethodIds } = req.body

    await database.transaction(async (client: any) => {
      if (routePath !== undefined || functionId !== undefined || allowedMethods !== undefined || isActive !== undefined) {
